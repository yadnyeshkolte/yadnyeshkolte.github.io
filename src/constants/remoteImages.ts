...
export const projectLightImages = {
  ...
  frontqodeImage: imageFromBranch('project-section-light-theme/structviz3dDesktopImage.webp'),
  ...
  onlinevotingsystemImage: imageFromBranch('project-section-light-theme/onlinevotingsystemImage.webp'),
  opensourcepenImage: imageFromBranch('project-section-light-theme/opensourcepenImage.webp'),
  structviz3dDesktopImage: imageFromBranch('project-section-light-theme/frontqodeImage.webp'),
  ...
  contextkeeperImage: imageFromBranch('project-section-light-theme/contextkeeperImage.webp'),
  readmeresurrectorImage: imageFromBranch('project-section-light-theme/readmeresurrectorImage.webp'),
} as const;
...
export const projectDarkImages = {
  ...
  frontqodeDarkImage: imageFromBranch('project-section-dark-theme/structviz3dDesktopDarkImage.webp'),
  ...
  onlinevotingsystemDarkImage: imageFromBranch('project-section-dark-theme/onlinevotingsystemDarkImage.webp'),
  opensourcepenDarkImage: imageFromBranch('project-section-dark-theme/opensourcepenDarkImage.webp'),
  structviz3dDesktopDarkImage: imageFromBranch('project-section-dark-theme/frontqodeDarkImage.webp'),
  ...
  contextkeeperDarkImage: imageFromBranch('project-section-dark-theme/contextkeeperDarkImage.webp'),
  readmeresurrectorDarkImage: imageFromBranch('project-section-dark-theme/readmeresurrectorDarkImage.webp'),
} as const;
